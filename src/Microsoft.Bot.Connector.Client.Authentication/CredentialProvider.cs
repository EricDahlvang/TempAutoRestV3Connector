...
namespace Microsoft.Bot.Connector.Client.Authentication
{
    ...
    public abstract class CredentialProvider
    {
        ...
        /// </para></remarks>
        public abstract Task<bool> IsValidAppIdAsync(string appId);
        ...
        /// that may need to call out to serviced to validate the appId / password pair.
        /// </para></remarks>
        public abstract Task<string> GetAppPasswordAsync(string appId);
        ...
        /// that may need to call out to serviced to validate the appId / password pair.
        /// </para></remarks>
        public abstract Task<bool> IsAuthenticationDisabledAsync();
    }
}
