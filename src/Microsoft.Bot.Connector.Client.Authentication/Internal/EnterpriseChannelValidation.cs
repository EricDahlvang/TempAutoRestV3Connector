...
namespace Microsoft.Bot.Connector.Client.Authentication
{
    ...
    /// </summary>
    internal sealed class EnterpriseChannelValidation
    {
        /// <summary>
...
#pragma warning disable VSTHRD200 // Use "Async" suffix for async methods (can't change this without breaking binary compat)
        public static async Task<ClaimsIdentity> AuthenticateChannelToken(string authHeader, CredentialProvider credentials, ChannelProvider channelProvider, string serviceUrl, HttpClient httpClient, string channelId)
#pragma warning restore VSTHRD200 // Use "Async" suffix for async methods
        ...
        /// <returns>ClaimsIdentity.</returns>
#pragma warning disable VSTHRD200 // Use "Async" suffix for async methods (can't change this without breaking binary compat)
        public static async Task<ClaimsIdentity> AuthenticateChannelToken(string authHeader, CredentialProvider credentials, ChannelProvider channelProvider, string serviceUrl, HttpClient httpClient, string channelId, AuthenticationConfiguration authConfig)
#pragma warning restore VSTHRD200 // Use "Async" suffix for async methods
        {
            if (authConfig == null)
            {
...
#pragma warning disable VSTHRD200 // Use "Async" suffix for async methods (can't change this without breaking binary compat)
        public static async Task ValidateIdentity(ClaimsIdentity identity, CredentialProvider credentials, string serviceUrl)
#pragma warning restore VSTHRD200 // Use "Async" suffix for async methods
        {
            if (identity == null)
            {
