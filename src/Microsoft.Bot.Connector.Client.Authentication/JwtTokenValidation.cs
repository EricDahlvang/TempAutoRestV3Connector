...
namespace Microsoft.Bot.Connector.Client.Authentication
{
    ...
    public static class JwtTokenValidation
    {
        ...
        /// <summary>
        /// Authenticates a Authentication header.
        /// </summary>
        ...
        public static async Task<ClaimsIdentity> AuthenticateRequestAsync(Activity activity, string authHeader, CredentialProvider credentials, ChannelProvider provider, HttpClient httpClient = null)
        {
            return await AuthenticateRequestAsync(activity, authHeader, credentials, provider, new AuthenticationConfiguration(), httpClient).ConfigureAwait(false);
        }
        ...
        /// <remarks>If the task completes successfully, the result contains the claims-based
        /// identity for the request.</remarks>
        public static async Task<ClaimsIdentity> AuthenticateRequestAsync(Activity activity, string authHeader, CredentialProvider credentials, ChannelProvider provider, AuthenticationConfiguration authConfig, HttpClient httpClient = null)
        {
            if (authConfig == null)
            {
            ...
            var claimsIdentity = await ValidateAuthHeaderAsync(authHeader, credentials, provider, activity.ChannelId, authConfig, activity.ServiceUrl, httpClient ?? _httpClient).ConfigureAwait(false);
        ...
        /// <remarks>If the task completes successfully, the result contains the claims-based
        /// identity for the request.</remarks>
        public static async Task<ClaimsIdentity> ValidateAuthHeaderAsync(string authHeader, CredentialProvider credentials, ChannelProvider channelProvider, string channelId, string serviceUrl = null, HttpClient httpClient = null)
        {
            return await ValidateAuthHeaderAsync(authHeader, credentials, channelProvider, channelId, new AuthenticationConfiguration(), serviceUrl, httpClient).ConfigureAwait(false);
        }
        ...
        /// <remarks>If the task completes successfully, the result contains the claims-based
        /// identity for the request.</remarks>
        public static async Task<ClaimsIdentity> ValidateAuthHeaderAsync(string authHeader, CredentialProvider credentials, ChannelProvider channelProvider, string channelId, AuthenticationConfiguration authConfig, string serviceUrl = null, HttpClient httpClient = null)
        {
        ...
        /// </summary>
        private static async Task<ClaimsIdentity> AuthenticateTokenAsync(string authHeader, CredentialProvider credentials, ChannelProvider channelProvider, string channelId, AuthenticationConfiguration authConfig, string serviceUrl, HttpClient httpClient)
        {
